...
echo "🚀 Setting up enhanced Nigeria Conflict Tracker frontend..."
...
echo "🗺️ Installing professional mapping libraries..."
npm install \
  mapbox-gl \
  react-map-gl \
  @deck.gl/core \
...
echo "⚡ Installing state management and performance libraries..."
npm install \
  zustand \
  swr \
...
echo "🎨 Setting up Tailwind CSS configuration..."
...
echo ""
echo "🚀 Your Nigeria Conflict Tracker is ready for professional enhancement!"
