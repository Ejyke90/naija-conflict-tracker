#!/usr/bin/env python3
"""
Robust MySQL to PostgreSQL CSV Converter
Manually parses SQL file by splitting on semicolons while respecting quotes
Converts INSERT statements to CSV for reliable PostgreSQL import
"""
...
def main():
    ...
    parser = RobustSQLParser(mysql_file)
