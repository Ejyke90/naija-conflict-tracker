# Dashboard Monitoring Capability

## Purpose

Provide administrators with real-time visibility into the automated data collection and processing pipeline for the Nigeria Conflict Tracker. This capability enables proactive monitoring of system health, data quality metrics, and pipeline performance to ensure reliable conflict data collection and processing.
## Requirements
